...
**Status:** Plan only — extensively specify before implementation  
...
- [ ] Busy thinking → Contemplating + rotating sunburst
- [ ] Answer streams → indicator gone
- [ ] Reduced motion → no spin
- [ ] Opacity ~70%; sans font
