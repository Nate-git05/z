...
<<<<<<< HEAD
- Documented P3 terminal UX plan: unified turn flow (Idle / Busy / WaitingInput / message queue) — plan only, see `docs/uncertainty/terminal-ux-p3-plan.md`.
=======
...
>>>>>>> origin/cursor/z-verify-busy-ui-313a
